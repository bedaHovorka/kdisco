...
class BouncingBallsTest {
    ...
    @Test
    fun bouncingBallsStayWithinBoundsAfterCollisions() = runTest {
        ...
        class Ball(xi: Double, yi: Double, var vx: Double, var vy: Double) : Continuous() {
            ...
            override suspend fun actions() {
                x.start(); y.start()
                this.start()  // register Ball's own derivatives() for integration
        ...
        assertThat(anyMoved, "At least one ball should have moved").isTrue()
    }
}
